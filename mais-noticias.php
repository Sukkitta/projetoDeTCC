...
<body>
        ...
        ?>
            <div class="noticias">
                ...
                <div class="titulo" onclick="exibirNoticia(<?php echo $linha_usuario['id']; ?>)">
                    ...
                    <!-- <a href="noticia.php?id=<?php echo $linha_usuario['id']; ?>"><?php echo $linha_usuario['tituloNoticia']; ?></a> -->
                </div>
                <?php
                ...
                <div class="alinha" onclick="exibirNoticia(<?php echo $linha_usuario['id']; ?>)">
                    ...
                    <ul>
                        ...
                        <li class="dat-noticia"><?php echo $linha_usuario['datMateria']; ?></li>
                    </ul>
                    </a>
                </div>
            </div>
    ...
    <div class="container-2">
        <div class="conteiner_paginacao">
            ...
            <a class="paginacao simbolo" href="mais-noticias.php?pagina=1"><</a>
                    <?php
                    for ($pag_ant = $pagina - $max_link; $pag_ant <= $pagina - 1; $pag_ant++) {
                        if ($pag_ant >= 1) {
                    ?>
                            <a class="paginacao active" href="mais-noticias.php?pagina=<?php echo $pag_ant; ?>"><?php echo $pag_ant; ?></a>
                        <?php
                    ...
                    for ($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_link; $pag_dep++) {
                        ...
                        ?>
                            <a class="paginacao" href="mais-noticias.php?pagina=<?php echo $pag_dep; ?>"><?php echo $pag_dep; ?></a>
                    <?php
                        }
                    }
                    ?>
                    <a class="paginacao simbolo" href="mais-noticias.php?pagina=<?php echo $quantidade_paginacao; ?>">></a>
        </div>
    </div>
