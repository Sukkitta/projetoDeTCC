...
<body>
    ...
    <h2>Notícias: Teamfight Tactics</h2>
    ...
    $sql = "SELECT * from noticias  WHERE id_categoria ='4' ORDER BY id DESC LIMIT $inicio, $qnt_result_pg ";
    ...
    <div class="container-2">
        <div class="conteiner_paginacao">
            ...
            <a class="paginacao simbolo" href="tft.php?pagina=1"><</a>
                    <?php
                    for ($pag_ant = $pagina - $max_link; $pag_ant <= $pagina - 1; $pag_ant++) {
                        if ($pag_ant >= 1) {
                    ?>
                            <a class="paginacao active" href="tft.php?pagina=<?php echo $pag_ant; ?>"><?php echo $pag_ant; ?></a>
                        <?php
                    ...
                    for ($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_link; $pag_dep++) {
                        ...
                        ?>
                            <a class="paginacao" href="tft.php?pagina=<?php echo $pag_dep; ?>"><?php echo $pag_dep; ?></a>
                    <?php
                        }
                    }
                    ?>
                    <a class="paginacao simbolo" href="tft.php?pagina=<?php echo $quantidade_paginacao; ?>">></a>
        </div>
    </div>
